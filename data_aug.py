import legacy.utls.dataset_manager as dm
import platform
import sys
import argparse
...
def config_model():
    ...
    base_dir = "/home/panpan/DexiNed/datasets/" if in_linux else "../../dataset/"
    parser = argparse.ArgumentParser(description='Basic details to run HED')
    # dataset config
    parser.add_argument('--train_dataset', default='BIPEDv2', choices=['BIPED','BSDS', 'BIPEDv2'])
